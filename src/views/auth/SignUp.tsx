...
import { ROUTER_PATH, getTimeFormatByLocalization, sendSuccessNotification } from '../../shared';
...
export default function SignUp() {
  ...
  const form = useForm({
    ...
    validate: {
      ...
      password: (v) => (passwordSchema.validate(v) ? null : t('signUp.fields.password.invalid')),
      confirm: (v, values) =>
  ...
  return (
    ...
    >
      ...
      <Divider my='xl' color='rgba(255,255,255,0.1)' labelPosition='center' />
