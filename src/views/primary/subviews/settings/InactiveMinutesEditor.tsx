    ...
    >
      <form onSubmit={handleSave}>
        <Stack gap='md'>
          ...
          <Text size='sm' ta='center' c='gray.5' style={{ opacity: 0.8, lineHeight: 1.4 }}>
            {t('main.inactiveMinutes.description')}
          </Text>

          {!isEditing ? (
            <Text ta='center' size='sm' c='gray.3' style={{ fontWeight: 500 }}>
          ...
          <Group grow>
            {!isEditing ? (
              ...
              <>
                ...
                <Button onClick={handleCancel} color='gray' radius='sm' variant='light' fullWidth>
